...
<head>
    ...
    <link rel="icon"
        href={{ app('site_info')->horizontal_logo ? route('get.image', ['path' => 'website', 'subpath' => 'images', 'image' => app('site_info')->favicon]) : '' }}>
...
<body style="overflow-y: hidden">
    <div class="admin d-flex flex-column">
        <div class="d-flex">
            <nav class="admin__navbar d-flex flex-column" style="width: 200px;">
                <div class="d-flex  align-items-center bg-white"
                    style="cursor: pointer; border-right: solid rgb(211, 211, 211) 1px; z-index: 2; height: 50px; "
                    id='nav-dropdown'>
                    <img src={{ app('site_info')->horizontal_logo ? route('get.image', ['path' => 'website', 'subpath' => 'images', 'image' => app('site_info')->horizontal_logo]) : '../img/Logo.png' }}
                        style='height:100%' alt="burguerhouse">
